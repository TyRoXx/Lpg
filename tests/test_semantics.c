...
void test_semantics(void)
{
...

    {
        ...
        instruction const expected_body_elements[] = {
            instruction_create_literal(literal_instruction_create(
                0, value_from_enum_element(1, &state), type_from_enumeration(&std_library.stable->option))),
    ...
    /*runtime evaluated match*/
    {
        ...
        instruction const expected_body_elements[] = {
            ...
            instruction_create_literal(literal_instruction_create(
                5, value_from_enum_element(0, NULL), type_from_enumeration(&std_library.stable->boolean))),
...
static void test_functions(const standard_library_description *std_library)
{
    ...
    }
    {
        ...
        {
            *signature_lambda =
                function_pointer_create(type_from_type(), tuple_type_create(NULL, 0), tuple_type_create(NULL, 0));
            unicode_string const register_debug_names[] = {
    ...
    }
    {
        ...
        }
        {
            ...
            *signature_lambda =
                function_pointer_create(type_from_type(), tuple_type_create(parameters, 1), tuple_type_create(NULL, 0));
    ...
    }
    {
        ...
        instruction const expected_main_function[] = {
            instruction_create_literal(literal_instruction_create(
                values[0], value_from_enum_element(0, NULL), type_from_enumeration(&std_library->stable->boolean))),
            instruction_create_literal(literal_instruction_create(
                values[1], value_from_enum_element(1, NULL), type_from_enumeration(&std_library->stable->boolean))),
...
static void test_loops(const standard_library_description *std_library)
{
    ...
    }
    {
        ...
        expected_body_elements[1] = instruction_create_literal(literal_instruction_create(
            1, value_from_enum_element(0, NULL), type_from_enumeration(&std_library->stable->boolean)));
...
static void test_assert(const standard_library_description *std_library)
{
    ...
    }
    {
        ...
        instruction const expected_body_elements[] = {
            instruction_create_global(0), instruction_create_read_struct(read_struct_instruction_create(0, 4, 1)),
            instruction_create_literal(literal_instruction_create(
                2, value_from_enum_element(0, NULL), type_from_enumeration(&std_library->stable->boolean))),
            instruction_create_call(call_instruction_create(1, arguments, 1, 3))};
        check_single_wellformed_function(

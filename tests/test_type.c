...
void test_type(void)
{
    ...
    }
    {
        ...
        function_pointer const right =
            function_pointer_create(type_from_unit(), &arguments, 1);
        REQUIRE(!type_equals(type_from_function_pointer(&left),
                             type_from_function_pointer(&right)));
    }
    {
        ...
        function_pointer const left =
            function_pointer_create(type_from_unit(), &left_arguments, 1);
        type right_arguments = type_from_integer_range(
            integer_range_create(integer_create(0, 0), integer_create(0, 0)));
        function_pointer const right =
            function_pointer_create(type_from_unit(), &right_arguments, 1);
        REQUIRE(!type_equals(type_from_function_pointer(&left),
                             type_from_function_pointer(&right)));
    }
}

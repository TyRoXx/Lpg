...
static void test_function_pointer_convertible(void)
{
    ...
    function_pointer function_pointer1 =
        function_pointer_create(small_range, tuple_type_create(arguments, 2), tuple_type_create(NULL, 0));
    ...
    REQUIRE(is_implicitly_convertible(function1, function1));
    {
        function_pointer function_pointer2 =
            function_pointer_create(big_range, tuple_type_create(arguments, 2), tuple_type_create(NULL, 0));
    ...
    }
    {
        ...
        function_pointer function_pointer2 =
            function_pointer_create(big_range, tuple_type_create(more_arguments, 3), tuple_type_create(NULL, 0));
        type function2 = type_from_function_pointer(&function_pointer2);
...
{
    {
        ...
        type type_list =
            type_from_integer_range(integer_range_create(integer_create(10, 100), integer_create(100, 30)));
        tuple_type const tuple_type1 = {&type_list, 1};
    ...
    }
    {
        type big_int_type =
            type_from_integer_range(integer_range_create(integer_create(10, 100), integer_create(100, 30)));
        type small_int_type =
            type_from_integer_range(integer_range_create(integer_create(1, 100), integer_create(200, 70)));
        tuple_type const left_tuple_type = {&big_int_type, 1};
        tuple_type const right_tuple_type = {&small_int_type, 1};

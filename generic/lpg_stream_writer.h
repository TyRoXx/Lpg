...
LPG_USE_RESULT success_indicator stream_writer_write_string(
    stream_writer writer, LPG_NON_NULL(char const *c_str));
...
LPG_USE_RESULT stream_writer
memory_writer_erase(LPG_NON_NULL(memory_writer *writer));

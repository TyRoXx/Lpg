...
integer integer_shift_left_truncate(integer value,
                                    uint32_t bits) LPG_USE_RESULT;
bool integer_shift_left(LPG_NON_NULL(integer *value),
                        uint32_t bits) LPG_USE_RESULT;
...
bool integer_multiply(LPG_NON_NULL(integer *left),
                      integer right) LPG_USE_RESULT;
bool integer_add(LPG_NON_NULL(integer *left), integer right) LPG_USE_RESULT;
bool integer_parse(LPG_NON_NULL(integer *into),
                   unicode_view from) LPG_USE_RESULT;
...
integer_division integer_divide(integer numerator,
                                integer denominator) LPG_USE_RESULT;

...
void *copy_array_impl(LPG_NON_NULL(void const *from), size_t size_in_bytes) LPG_USE_RESULT;

#define LPG_COPY_ARRAY(array) copy_array_impl((array), sizeof(array)), LPG_ARRAY_SIZE(array)

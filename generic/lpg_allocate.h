...
void *reallocate_array(void *memory, size_t new_size,
                       size_t element) LPG_USE_RESULT;
...
void *copy_array_impl(LPG_NON_NULL(void const *from),
                      size_t size_in_bytes) LPG_USE_RESULT;
